...
HD_PWD='C:/Users/TOSHIBA/Vivado_Labs/Lab9-10/Lab9-10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nanoprocessor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nanoprocessor.tcl -notrace
